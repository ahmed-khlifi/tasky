...
export default function KanbanColumnTitle({ title }: { title: string }) {
    return (
        <div className='flex items-center justify-between mb-4 bg-white p-4 rounded-lg'>
            ...
            <div className="bg-[#E8EAFF] p-2 rounded-lg cursor-pointer hover:bg-gray-300 transition-colors duration-200">
